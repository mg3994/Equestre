...
class HorseInfo {
  ...
  static HorseInfo decode(Object result) {
    result as List<Object?>;
    return HorseInfo(
      name: result[0]! as String,
      number: result[1]! as int,
      rider: result[2]! as String,
    );
  }
}
...
class LiveMatchStatus {
  ...
  static LiveMatchStatus decode(Object result) {
    result as List<Object?>;
    return LiveMatchStatus(
      isLive: result[0]! as bool,
...
class PenaltyInfo {
  ...
  static PenaltyInfo decode(Object result) {
    result as List<Object?>;
    return PenaltyInfo(
...
class TimeInfo {
  ...
  static TimeInfo decode(Object result) {
    result as List<Object?>;
    return TimeInfo(
      seconds: result[0]! as double,
      display: result[1]! as String,
    );
  }
}
...
class RankInfo {
  ...
  static RankInfo decode(Object result) {
    result as List<Object?>;
    return RankInfo(
...
class GapToBestInfo {
  ...
  static GapToBestInfo decode(Object result) {
    result as List<Object?>;
    return GapToBestInfo(
      gapSeconds: result[0]! as double,
      isFaster: result[1]! as bool,
      display: result[2] as String?,
    );
  }
}
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is PigeonSensorPosition) {
      ...
      buffer.putUint8(137);
      writeValue(buffer, value.index);
    } else     if (value is HorseInfo) {
      buffer.putUint8(138);
      writeValue(buffer, value.encode());
    } else     if (value is LiveMatchStatus) {
      buffer.putUint8(139);
      writeValue(buffer, value.encode());
    } else     if (value is PenaltyInfo) {
      buffer.putUint8(140);
      writeValue(buffer, value.encode());
    } else     if (value is TimeInfo) {
      buffer.putUint8(141);
      writeValue(buffer, value.encode());
    } else     if (value is RankInfo) {
      buffer.putUint8(142);
      writeValue(buffer, value.encode());
    } else     if (value is GapToBestInfo) {
      buffer.putUint8(143);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 138: 
        return HorseInfo.decode(readValue(buffer)!);
      case 139: 
        return LiveMatchStatus.decode(readValue(buffer)!);
      case 140: 
        return PenaltyInfo.decode(readValue(buffer)!);
      case 141: 
        return TimeInfo.decode(readValue(buffer)!);
      case 142: 
        return RankInfo.decode(readValue(buffer)!);
      case 143: 
        return GapToBestInfo.decode(readValue(buffer)!);
      case 144: 
...
class HorseApi {
  /// Constructor for [HorseApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  HorseApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<void> updateHorseInfo(HorseInfo horse) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.HorseApi.updateHorseInfo$pigeonVar_messageChannelSuffix';
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[horse]) as List<Object?>?;
...
class LiveMatchApi {
  /// Constructor for [LiveMatchApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  LiveMatchApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
      : pigeonVar_binaryMessenger = binaryMessenger,
        pigeonVar_messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
  final BinaryMessenger? pigeonVar_binaryMessenger;
  ...
  Future<void> updateLiveStatus(LiveMatchStatus status) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.LiveMatchApi.updateLiveStatus$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
class PenaltyApi {
  /// Constructor for [PenaltyApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  PenaltyApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
      : pigeonVar_binaryMessenger = binaryMessenger,
        pigeonVar_messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
  final BinaryMessenger? pigeonVar_binaryMessenger;
  ...
  Future<void> updatePenalty(PenaltyInfo penalty) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.PenaltyApi.updatePenalty$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[penalty]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
...
class TimeApi {
  /// Constructor for [TimeApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  TimeApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
      : pigeonVar_binaryMessenger = binaryMessenger,
        pigeonVar_messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
  final BinaryMessenger? pigeonVar_binaryMessenger;
  ...
  Future<void> updateTime(TimeInfo time) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.TimeApi.updateTime$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
class RankApi {
  /// Constructor for [RankApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  RankApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
      : pigeonVar_binaryMessenger = binaryMessenger,
        pigeonVar_messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
  final BinaryMessenger? pigeonVar_binaryMessenger;
  ...
  Future<void> updateRank(RankInfo rank) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.RankApi.updateRank$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[rank]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
...
class GapToBestApi {
  /// Constructor for [GapToBestApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  GapToBestApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
      : pigeonVar_binaryMessenger = binaryMessenger,
        pigeonVar_messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
  final BinaryMessenger? pigeonVar_binaryMessenger;
  ...
  Future<void> updateGapToBest(GapToBestInfo gap) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camerawesome.GapToBestApi.updateGapToBest$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[gap]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
