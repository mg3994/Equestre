...
data class HorseInfo (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): HorseInfo {
      val name = pigeonVar_list[0] as String
      val number = pigeonVar_list[1].let { num -> if (num is Int) num.toLong() else num as Long }
      val rider = pigeonVar_list[2] as String
      return HorseInfo(name, number, rider)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class LiveMatchStatus (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): LiveMatchStatus {
      val isLive = pigeonVar_list[0] as Boolean
      val message = pigeonVar_list[1] as String?
      return LiveMatchStatus(isLive, message)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class PenaltyInfo (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PenaltyInfo {
      val value = pigeonVar_list[0] as Double
      val description = pigeonVar_list[1] as String
      return PenaltyInfo(value, description)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class TimeInfo (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): TimeInfo {
      val seconds = pigeonVar_list[0] as Double
      val display = pigeonVar_list[1] as String
      return TimeInfo(seconds, display)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class RankInfo (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): RankInfo {
      val position = pigeonVar_list[0].let { num -> if (num is Int) num.toLong() else num as Long }
      val label = pigeonVar_list[1] as String?
      return RankInfo(position, label)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
data class GapToBestInfo (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): GapToBestInfo {
      val gapSeconds = pigeonVar_list[0] as Double
      val isFaster = pigeonVar_list[1] as Boolean
      val display = pigeonVar_list[2] as String?
      return GapToBestInfo(gapSeconds, isFaster, display)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
    ...
    return when (type) {
      ...
      138.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          HorseInfo.fromList(it)
        }
      }
      139.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          LiveMatchStatus.fromList(it)
        }
      }
      140.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          PenaltyInfo.fromList(it)
        }
      }
      141.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          TimeInfo.fromList(it)
        }
      }
      142.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          RankInfo.fromList(it)
        }
      }
      143.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          GapToBestInfo.fromList(it)
        }
      }
      144.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
...
interface HorseApi {
  fun updateHorseInfo(horse: HorseInfo)

  companion object {
    /** The codec used by HorseApi. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonPigeonCodec
    }
    /** Sets up an instance of `HorseApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: HorseApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.HorseApi.updateHorseInfo$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val horseArg = args[0] as HorseInfo
            val wrapped: List<Any?> = try {
              api.updateHorseInfo(horseArg)
              listOf(null)
...
interface LiveMatchApi {
  fun updateLiveStatus(status: LiveMatchStatus)

  companion object {
    /** The codec used by LiveMatchApi. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonPigeonCodec
    }
    /** Sets up an instance of `LiveMatchApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: LiveMatchApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.LiveMatchApi.updateLiveStatus$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val statusArg = args[0] as LiveMatchStatus
            val wrapped: List<Any?> = try {
              api.updateLiveStatus(statusArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
...
interface PenaltyApi {
  fun updatePenalty(penalty: PenaltyInfo)

  companion object {
    /** The codec used by PenaltyApi. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonPigeonCodec
    }
    /** Sets up an instance of `PenaltyApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: PenaltyApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.PenaltyApi.updatePenalty$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val penaltyArg = args[0] as PenaltyInfo
            val wrapped: List<Any?> = try {
              api.updatePenalty(penaltyArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
...
/** Generated interface from Pigeon that represents a handler of messages from Flutter. */
interface TimeApi {
  fun updateTime(time: TimeInfo)

  companion object {
    /** The codec used by TimeApi. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonPigeonCodec
    }
    /** Sets up an instance of `TimeApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: TimeApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.TimeApi.updateTime$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val timeArg = args[0] as TimeInfo
            val wrapped: List<Any?> = try {
              api.updateTime(timeArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
...
/** Generated interface from Pigeon that represents a handler of messages from Flutter. */
interface RankApi {
  fun updateRank(rank: RankInfo)

  companion object {
    /** The codec used by RankApi. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonPigeonCodec
    }
    /** Sets up an instance of `RankApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: RankApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.RankApi.updateRank$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val rankArg = args[0] as RankInfo
            val wrapped: List<Any?> = try {
              api.updateRank(rankArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
...
/** Generated interface from Pigeon that represents a handler of messages from Flutter. */
interface GapToBestApi {
  fun updateGapToBest(gap: GapToBestInfo)

  companion object {
    /** The codec used by GapToBestApi. */
    val codec: MessageCodec<Any?> by lazy {
      PigeonPigeonCodec
    }
    /** Sets up an instance of `GapToBestApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: GapToBestApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.GapToBestApi.updateGapToBest$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val gapArg = args[0] as GapToBestInfo
            val wrapped: List<Any?> = try {
              api.updateGapToBest(gapArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
