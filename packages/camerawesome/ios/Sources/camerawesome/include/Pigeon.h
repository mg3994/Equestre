...
@interface LiveMatchStatus : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
@interface PenaltyInfo : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
@interface GapToBestInfo : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithGapSeconds:(double )gapSeconds
    isFaster:(BOOL )isFaster
    display:(nullable NSString *)display;
@property(nonatomic, assign) double  gapSeconds;
@property(nonatomic, assign) BOOL  isFaster;
...
@protocol HorseApi
- (void)updateHorseInfoHorse:(HorseInfo *)horse error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpHorseApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<HorseApi> *_Nullable api);

extern void SetUpHorseApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<HorseApi> *_Nullable api, NSString *messageChannelSuffix);


@protocol LiveMatchApi
- (void)updateLiveStatusStatus:(LiveMatchStatus *)status error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpLiveMatchApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LiveMatchApi> *_Nullable api);

extern void SetUpLiveMatchApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LiveMatchApi> *_Nullable api, NSString *messageChannelSuffix);


@protocol PenaltyApi
- (void)updatePenaltyPenalty:(PenaltyInfo *)penalty error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpPenaltyApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PenaltyApi> *_Nullable api);

extern void SetUpPenaltyApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PenaltyApi> *_Nullable api, NSString *messageChannelSuffix);


@protocol TimeApi
- (void)updateTimeTime:(TimeInfo *)time error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpTimeApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<TimeApi> *_Nullable api);

extern void SetUpTimeApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<TimeApi> *_Nullable api, NSString *messageChannelSuffix);


@protocol RankApi
- (void)updateRankRank:(RankInfo *)rank error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpRankApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<RankApi> *_Nullable api);

extern void SetUpRankApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<RankApi> *_Nullable api, NSString *messageChannelSuffix);


@protocol GapToBestApi
- (void)updateGapToBestGap:(GapToBestInfo *)gap error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpGapToBestApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<GapToBestApi> *_Nullable api);

extern void SetUpGapToBestApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<GapToBestApi> *_Nullable api, NSString *messageChannelSuffix);
