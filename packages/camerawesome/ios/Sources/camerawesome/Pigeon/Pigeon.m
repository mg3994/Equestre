...
@interface HorseInfo ()
+ (HorseInfo *)fromList:(NSArray<id> *)list;
+ (nullable HorseInfo *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface LiveMatchStatus ()
+ (LiveMatchStatus *)fromList:(NSArray<id> *)list;
+ (nullable LiveMatchStatus *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface PenaltyInfo ()
+ (PenaltyInfo *)fromList:(NSArray<id> *)list;
+ (nullable PenaltyInfo *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface TimeInfo ()
+ (TimeInfo *)fromList:(NSArray<id> *)list;
+ (nullable TimeInfo *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface RankInfo ()
+ (RankInfo *)fromList:(NSArray<id> *)list;
+ (nullable RankInfo *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface GapToBestInfo ()
+ (GapToBestInfo *)fromList:(NSArray<id> *)list;
+ (nullable GapToBestInfo *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation HorseInfo
+ (instancetype)makeWithName:(NSString *)name
    number:(NSInteger )number
    rider:(NSString *)rider {
  HorseInfo* pigeonResult = [[HorseInfo alloc] init];
  pigeonResult.name = name;
  pigeonResult.number = number;
  pigeonResult.rider = rider;
  return pigeonResult;
}
+ (HorseInfo *)fromList:(NSArray<id> *)list {
  HorseInfo *pigeonResult = [[HorseInfo alloc] init];
  pigeonResult.name = GetNullableObjectAtIndex(list, 0);
  pigeonResult.number = [GetNullableObjectAtIndex(list, 1) integerValue];
  pigeonResult.rider = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable HorseInfo *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [HorseInfo fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.name ?: [NSNull null],
    @(self.number),
    self.rider ?: [NSNull null],
  ];
}
@end

@implementation LiveMatchStatus
+ (instancetype)makeWithIsLive:(BOOL )isLive
    message:(nullable NSString *)message {
  LiveMatchStatus* pigeonResult = [[LiveMatchStatus alloc] init];
...
+ (LiveMatchStatus *)fromList:(NSArray<id> *)list {
  LiveMatchStatus *pigeonResult = [[LiveMatchStatus alloc] init];
  pigeonResult.isLive = [GetNullableObjectAtIndex(list, 0) boolValue];
  pigeonResult.message = GetNullableObjectAtIndex(list, 1);
  return pigeonResult;
}
+ (nullable LiveMatchStatus *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [LiveMatchStatus fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.isLive),
...
@implementation PenaltyInfo
+ (instancetype)makeWithValue:(double )value
    description:(NSString *)description {
  PenaltyInfo* pigeonResult = [[PenaltyInfo alloc] init];
...
+ (nullable PenaltyInfo *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [PenaltyInfo fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.value),
...
+ (instancetype)makeWithSeconds:(double )seconds
    display:(NSString *)display {
  TimeInfo* pigeonResult = [[TimeInfo alloc] init];
  pigeonResult.seconds = seconds;
  pigeonResult.display = display;
  return pigeonResult;
}
+ (TimeInfo *)fromList:(NSArray<id> *)list {
  TimeInfo *pigeonResult = [[TimeInfo alloc] init];
  pigeonResult.seconds = [GetNullableObjectAtIndex(list, 0) doubleValue];
  pigeonResult.display = GetNullableObjectAtIndex(list, 1);
  return pigeonResult;
}
+ (nullable TimeInfo *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [TimeInfo fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.seconds),
    self.display ?: [NSNull null],
  ];
}
@end

@implementation RankInfo
+ (instancetype)makeWithPosition:(NSInteger )position
    label:(nullable NSString *)label {
  RankInfo* pigeonResult = [[RankInfo alloc] init];
...
+ (nullable RankInfo *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [RankInfo fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.position),
...
@implementation GapToBestInfo
+ (instancetype)makeWithGapSeconds:(double )gapSeconds
    isFaster:(BOOL )isFaster
    display:(nullable NSString *)display {
  GapToBestInfo* pigeonResult = [[GapToBestInfo alloc] init];
  pigeonResult.gapSeconds = gapSeconds;
  pigeonResult.isFaster = isFaster;
  pigeonResult.display = display;
  return pigeonResult;
}
+ (GapToBestInfo *)fromList:(NSArray<id> *)list {
  GapToBestInfo *pigeonResult = [[GapToBestInfo alloc] init];
  pigeonResult.gapSeconds = [GetNullableObjectAtIndex(list, 0) doubleValue];
  pigeonResult.isFaster = [GetNullableObjectAtIndex(list, 1) boolValue];
  pigeonResult.display = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable GapToBestInfo *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [GapToBestInfo fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.gapSeconds),
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 138: 
      return [HorseInfo fromList:[self readValue]];
    case 139: 
      return [LiveMatchStatus fromList:[self readValue]];
    case 140: 
      return [PenaltyInfo fromList:[self readValue]];
    case 141: 
      return [TimeInfo fromList:[self readValue]];
    case 142: 
      return [RankInfo fromList:[self readValue]];
    case 143: 
      return [GapToBestInfo fromList:[self readValue]];
    case 144: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[PigeonSensorPositionBox class]]) {
    ...
    [self writeByte:137];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[HorseInfo class]]) {
    [self writeByte:138];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[LiveMatchStatus class]]) {
    [self writeByte:139];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[PenaltyInfo class]]) {
    [self writeByte:140];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[TimeInfo class]]) {
    [self writeByte:141];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[RankInfo class]]) {
    [self writeByte:142];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[GapToBestInfo class]]) {
    [self writeByte:143];
    [self writeValue:[value toList]];
...
void SetUpHorseApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<HorseApi> *api) {
  SetUpHorseApiWithSuffix(binaryMessenger, api, @"");
}

void SetUpHorseApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<HorseApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.HorseApi.updateHorseInfo", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updateHorseInfoHorse:error:)], @"HorseApi api (%@) doesn't respond to @selector(updateHorseInfoHorse:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        HorseInfo *arg_horse = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api updateHorseInfoHorse:arg_horse error:&error];
...
void SetUpLiveMatchApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LiveMatchApi> *api) {
  SetUpLiveMatchApiWithSuffix(binaryMessenger, api, @"");
}

void SetUpLiveMatchApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LiveMatchApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.LiveMatchApi.updateLiveStatus", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updateLiveStatusStatus:error:)], @"LiveMatchApi api (%@) doesn't respond to @selector(updateLiveStatusStatus:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        LiveMatchStatus *arg_status = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api updateLiveStatusStatus:arg_status error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
...
void SetUpPenaltyApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PenaltyApi> *api) {
  SetUpPenaltyApiWithSuffix(binaryMessenger, api, @"");
}

void SetUpPenaltyApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PenaltyApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.PenaltyApi.updatePenalty", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updatePenaltyPenalty:error:)], @"PenaltyApi api (%@) doesn't respond to @selector(updatePenaltyPenalty:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        PenaltyInfo *arg_penalty = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api updatePenaltyPenalty:arg_penalty error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
...
void SetUpTimeApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<TimeApi> *api) {
  SetUpTimeApiWithSuffix(binaryMessenger, api, @"");
}

void SetUpTimeApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<TimeApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.TimeApi.updateTime", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updateTimeTime:error:)], @"TimeApi api (%@) doesn't respond to @selector(updateTimeTime:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        TimeInfo *arg_time = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api updateTimeTime:arg_time error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
...
void SetUpRankApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<RankApi> *api) {
  SetUpRankApiWithSuffix(binaryMessenger, api, @"");
}

void SetUpRankApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<RankApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.RankApi.updateRank", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updateRankRank:error:)], @"RankApi api (%@) doesn't respond to @selector(updateRankRank:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        RankInfo *arg_rank = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api updateRankRank:arg_rank error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
...
void SetUpGapToBestApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<GapToBestApi> *api) {
  SetUpGapToBestApiWithSuffix(binaryMessenger, api, @"");
}

void SetUpGapToBestApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<GapToBestApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.GapToBestApi.updateGapToBest", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updateGapToBestGap:error:)], @"GapToBestApi api (%@) doesn't respond to @selector(updateGapToBestGap:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        GapToBestInfo *arg_gap = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api updateGapToBestGap:arg_gap error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
